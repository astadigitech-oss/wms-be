...
use App\Http\Controllers\CardInfo\DataController;
...
Route::middleware(['auth:sanctum', 'check.role:Admin,Spv,Team leader'])->group(function () {
    ...
    Route::post('cek-perbedaan-total', [BulkController::class, 'checkMissingBarcode']);
});
...
Route::middleware(['auth:sanctum', 'check.role:Admin,Spv,Admin Kasir,Kasir leader,Team leader'])->group(function () {
    ...
    Route::post('outbound/lusi/fix-validation', [FixWmsValidationController::class, 'fixValidation']);
});
