...
return new class extends Migration
{
     ...
     * Run the migrations.
     */
    // 'display','expired','promo','bundle','palet','dump','sale','migrate','repair','pending_delete','stage_repair
    public function up(): void
    {
        ...
        $chunkSize = 1000;
        $totalRecords = DB::table('palet_products')->count();
        $processedRecords = 0;

        if ($totalRecords > 0) {
            DB::table('palet_products')
                ->orderBy('id')
